                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $plato->stock; ?></td>
                                    <td><?php echo $plato->estado; ?></td>
                                    <td><a class="btn btn-warning btn-mini" href="<?php echo constant('URL').'plato/verPlato/'.$plato->id_plato; ?>">Editar</a></td>
                                    <td><button type="button" name="btnElimiar" class="btn btn-danger btn-mini btnEliminar" data-id="<?php echo $plato->id_plato; ?>">Eliminar</button></td>
