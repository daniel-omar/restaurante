! function(e, a) {
      ...
      if (null != M.deprecationHandler && M.deprecationHandler(null, n), d) {
        ...
        for (a = 0; a < arguments.length; a++) {
          if (e = "", "object" == typeof arguments[a]) {
            for (t in e += "\n[" + a + "] ", arguments[0]) h(arguments[0], t) && (e += t + ": " + arguments[0][t] + ", ");
            e = e.slice(0, -2)
          } else e = arguments[a];
          s.push(e)
        }
  ...
  function E(e, a) {
    return e.isValid() ? (a = A(a, e.localeData()), O[a] = O[a] || function(s) {
      var e, n, a, r = s.match(j);
      for (e = 0, n = r.length; e < n; e++) P[r[e]] ? r[e] = P[r[e]] : r[e] = (a = r[e]).match(/\[[\s\S]/) ? a.replace(/^\[|\]$/g, "") : a.replace(/\\/g, "");
      return function(e) {
        var a, t = "";
        for (a = 0; a < n; a++) t += v(r[a]) ? r[a].call(e, s) : r[a];
        return t
      }
  ...
  function Ae() {
    ...
    for (s.sort(e), n.sort(e), r.sort(e), a = 0; a < 12; a++) s[a] = he(s[a]), n[a] = he(n[a]);
    for (a = 0; a < 24; a++) r[a] = he(r[a]);
  ...
  function Re(e, a, t, s, n) {
    var r, d, _ = 1 + 7 * (a - 1) + (7 + t - s) % 7 + Je(e, s, n);
    return d = _ <= 0 ? Fe(r = e - 1) + _ : _ > Fe(e) ? (r = e + 1, _ - Fe(e)) : (r = e, _), {
      year: r,
      dayOfYear: d
    }
  }
  ...
  function $e() {
    ...
    var a, t, s, n, r, d = [],
      ...
      i = [],
      o = [];
    for (a = 0; a < 7; a++) t = c([2e3, 1]).day(a), s = he(this.weekdaysMin(t, "")), n = he(this.weekdaysShort(t, "")), r = he(this.weekdays(t, "")), d.push(s), _.push(n), i.push(r), o.push(s), o.push(n), o.push(r);
    d.sort(e), _.sort(e), i.sort(e), o.sort(e), this._weekdaysRegex = new RegExp("^(" + o.join("|") + ")", "i"), this._weekdaysShortRegex = this._weekdaysRegex, this._weekdaysMinRegex = this._weekdaysRegex, this._weekdaysStrictRegex = new RegExp("^(" + i.join("|") + ")", "i"), this._weekdaysShortStrictRegex = new RegExp("^(" + _.join("|") + ")", "i"), this._weekdaysMinStrictRegex = new RegExp("^(" + d.join("|") + ")", "i")
  }
  ...
  function ua(e) {
    ...
    return function(e) {
      for (var a, t, s, n, r = 0; r < e.length;) {
        for (a = (n = _a(e[r]).split("-")).length, t = (t = _a(e[r + 1])) ? t.split("-") : null; 0 < a;) {
          if (s = ia(n.slice(0, a).join("-"))) return s;
          if (t && t.length >= a && da(n, t) >= a - 1) break;
          a--
        }
        r++
      }
  ...
  function wa(e) {
    ...
    if (!e._d) {
      var _, i;
      for (_ = e, i = new Date(M.now()), s = _._useUTC ? [i.getUTCFullYear(), i.getUTCMonth(), i.getUTCDate()] : [i.getFullYear(), i.getMonth(), i.getDate()], e._w && null == e._a[ke] && null == e._a[pe] && function(e) {
        ...
        }(e), null != e._dayOfYear && (r = ga(e._a[fe], s[fe]), (e._dayOfYear > Fe(r) || 0 === e._dayOfYear) && (L(e)._overflowDayOfYear = !0), t = Ne(r, 0, e._dayOfYear), e._a[pe] = t.getUTCMonth(), e._a[ke] = t.getUTCDate()), a = 0; a < 3 && null == e._a[a]; ++a) e._a[a] = d[a] = s[a];
      ...
      }).apply(null, d), n = e._useUTC ? e._d.getUTCDay() : e._d.getDay(), null != e._tzm && e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), e._nextDay && (e._a[De] = 24), e._w && void 0 !== e._w.d && e._w.d !== n && (L(e).weekdayMismatch = !0)
    }
  }
  ...
  function va(e) {
    if (e._f !== M.ISO_8601)
      if (e._f !== M.RFC_2822) {
        e._a = [], L(e).empty = !0;
        var a, t, s, n, r, d, _, i, o, m = "" + e._i,
          u = m.length,
          l = 0;
        for (s = A(e._f, e._locale).match(j) || [], a = 0; a < s.length; a++) n = s[a], (t = (m.match(Me(n, e)) || [])[0]) && (0 < (r = m.substr(0, m.indexOf(t))).length && L(e).unusedInput.push(r), m = m.slice(m.indexOf(t) + t.length), l += t.length), P[n] ? (t ? L(e).empty = !1 : L(e).unusedTokens.push(n), _ = n, o = e, null != (i = t) && h(ce, _) && ce[_](i, o._a, o, _)) : e._strict && !t && L(e).unusedTokens.push(n);
        L(e).charsLeftOver = u - l, 0 < m.length && L(e).unusedInput.push(m), e._a[De] <= 12 && !0 === L(e).bigHour && 0 < e._a[De] && (L(e).bigHour = void 0), L(e).parsedDateParts = e._a.slice(0), L(e).meridiem = e._meridiem, e._a[De] = function(e, a, t) {
          var s;
          if (null == t) return a;
          return null != e.meridiemHour ? e.meridiemHour(a, t) : (null != e.isPM && ((s = e.isPM(t)) && a < 12 && (a += 12), s || 12 !== a || (a = 0)), a)
        }(e._locale, e._a[De], e._meridiem), null !== (d = L(e).era) && (e._a[fe] = e._locale.erasConvertYear(d, e._a[fe])), wa(e), la(e)
      } else Ta(e);
    else ka(e)
  }
  ...
  function Ga(e, a) {
    ...
    return Ea(e) ? r = {
      ...
      return t
    }(Sa(r.from), Sa(r.to)), (r = {}).ms = n.milliseconds, r.M = n.months), s = new Wa(r), Ea(e) && h(e, "_locale") && (s._locale = e._locale), Ea(e) && h(e, "_isValid") && (s._isValid = e._isValid), s
  }
  ...
  function ot() {
    var e, a, t = [],
      ...
      r = [],
      d = this.eras();
    for (e = 0, a = d.length; e < a; ++e) s.push(he(d[e].name)), t.push(he(d[e].abbr)), n.push(he(d[e].narrow)), r.push(he(d[e].name)), r.push(he(d[e].abbr)), r.push(he(d[e].narrow));
  ...
  yt.add = Za, yt.calendar = function(e, a) {
    1 === arguments.length && (Xa(arguments[0]) ? (e = arguments[0], a = void 0) : function(e) {
      ...
      for (a = 0; a < n.length; a += 1) s = s || h(e, n[a]);
      return t && s
    ...
    return t.year() < 0 || 9999 < t.year() ? E(t, a ? "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYYYY-MM-DD[T]HH:mm:ss.SSSZ") : v(Date.prototype.toISOString) ? a ? this.toDate().toISOString() : new Date(this.valueOf() + 60 * this.utcOffset() * 1e3).toISOString().replace("Z", E(t, "Z")) : E(t, a ? "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYY-MM-DD[T]HH:mm:ss.SSSZ")
  }, yt.inspect = function() {
    ...
    for (e = 0, a = s.length; e < a; ++e) {
      if (t = this.startOf("day").valueOf(), s[e].since <= t && t <= s[e].until) return s[e].name;
    ...
    var e, a, t, s = this.localeData().eras();
    for (e = 0, a = s.length; e < a; ++e) {
      if (t = this.startOf("day").valueOf(), s[e].since <= t && t <= s[e].until) return s[e].narrow;
    ...
    var e, a, t, s = this.localeData().eras();
    for (e = 0, a = s.length; e < a; ++e) {
      if (t = this.startOf("day").valueOf(), s[e].since <= t && t <= s[e].until) return s[e].abbr;
      if (s[e].until <= t && t <= s[e].since) return s[e].abbr
    }
    return ""
  }, yt.eraYear = function() {
    var e, a, t, s, n = this.localeData().eras();
    for (e = 0, a = n.length; e < a; ++e)
      if (t = n[e].since <= n[e].until ? 1 : -1, s = this.startOf("day").valueOf(), n[e].since <= s && s <= n[e].until || n[e].until <= s && s <= n[e].since) return (this.year() - M(n[e].since).year()) * t + n[e].offset;
    return this.year()
  ...
  }, yt.month = Ee, yt.daysInMonth = function() {
  ...
  }, yt.dates = t("dates accessor is deprecated. Use date instead.", lt), yt.months = t("months accessor is deprecated. Use month instead", Ee), yt.years = t("years accessor is deprecated. Use year instead", ze), yt.zone = t("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", function(e, a) {
    ...
    return p(a, this), (a = Ha(a))._a ? (e = (a._isUTC ? c : Sa)(a._a), this._isDSTShifted = this.isValid() && 0 < function(e, a, t) {
      var s, n = Math.min(e.length, a.length),
        ...
        d = 0;
      for (s = 0; s < n; s++)(t && e[s] !== a[s] || !t && G(e[s]) !== G(a[s])) && d++;
      return d + r
  ...
  function Dt(e, a, t) {
    ...
    var s, n = [];
    for (s = 0; s < 12; s++) n[s] = kt(e, s, t, "month");
    return n
  }
  ...
  pt.calendar = function(e, a, t) {
    ...
    var t, s, n, r = this._eras || ua("en")._eras;
    for (t = 0, s = r.length; t < s; ++t) {
      switch (typeof r[t].since) {
        case "string":
          n = M(r[t].since).startOf("day"), r[t].since = n.valueOf();
          break
      }
      switch (typeof r[t].until) {
        case "undefined":
          ...
          break;
        case "string":
          n = M(r[t].until).startOf("day").valueOf(), r[t].until = n.valueOf();
          break
      }
    }
    return r
    ...
    return this._monthsParseExact ? (h(this, "_monthsRegex") || Ae.call(this), e ? this._monthsStrictRegex : this._monthsRegex) : (h(this, "_monthsRegex") || (this._monthsRegex = Pe), this._monthsStrictRegex && e ? this._monthsStrictRegex : this._monthsRegex)
  }, pt.monthsShortRegex = function(e) {
    return this._monthsParseExact ? (h(this, "_monthsRegex") || Ae.call(this), e ? this._monthsShortStrictRegex : this._monthsShortRegex) : (h(this, "_monthsShortRegex") || (this._monthsShortRegex = Oe), this._monthsShortStrictRegex && e ? this._monthsShortStrictRegex : this._monthsShortRegex)
  }, pt.week = function(e) {
  ...
  Xt.isValid = function() {
  ...
  }, Xt.asMilliseconds = jt, Xt.asSeconds = xt, Xt.asMinutes = Ot, Xt.asHours = Pt, Xt.asDays = Wt, Xt.asWeeks = Et, Xt.asMonths = At, Xt.asQuarters = Ft, Xt.asYears = zt, Xt.valueOf = function() {
    ...
    t._d = new Date(G(e))
  }), M.version = "2.25.3", e = Sa, M.fn = yt, M.min = function() {
  ...
  }, M.localeData = ua, M.isDuration = Ea, M.monthsShort = function(e, a) {
    ...
    if (null != a) {
      var t, s, n = sa;
      null != na[e] && null != na[e].parentLocale ? na[e].set(H(na[e]._config, a)) : (null != (s = ia(e)) && (n = s._config), a = H(n, a), null == s && (a.abbr = e), (t = new b(a)).parentLocale = na[e], na[e] = t), oa(e)
    } else null != na[e] && (null != na[e].parentLocale ? (na[e] = na[e].parentLocale, e === oa() && oa(e)) : null != na[e] && delete na[e]);
    return na[e]
  }, M.locales = function() {
    return s(na)
  ...
  M.defineLocale("az", {
    ...
    ordinal: function(e) {
      ...
      var a = e % 10;
      return e + (Ms[a] || Ms[e % 100 - a] || Ms[100 <= e ? 100 : null])
    },
    week: {
      dow: 1,
      doy: 7
  ...
  var ks = "leden_\xfanor_b\u0159ezen_duben_kv\u011bten_\u010derven_\u010dervenec_srpen_z\xe1\u0159\xed_\u0159\xedjen_listopad_prosinec".split("_"),
    Ds = "led_\xfano_b\u0159e_dub_kv\u011b_\u010dvn_\u010dvc_srp_z\xe1\u0159_\u0159\xedj_lis_pro".split("_"),
    Ts = [/^led/i, /^\xfano/i, /^b\u0159e/i, /^dub/i, /^kv\u011b/i, /^(\u010dvn|\u010derven$|\u010dervna)/i, /^(\u010dvc|\u010dervenec|\u010dervence)/i, /^srp/i, /^z\xe1\u0159/i, /^\u0159\xedj/i, /^lis/i, /^pro/i],
    gs = /^(leden|\xfanor|b\u0159ezen|duben|kv\u011bten|\u010dervenec|\u010dervence|\u010derven|\u010dervna|srpen|z\xe1\u0159\xed|\u0159\xedjen|listopad|prosinec|led|\xfano|b\u0159e|dub|kv\u011b|\u010dvn|\u010dvc|srp|z\xe1\u0159|\u0159\xedj|lis|pro)/i;
  ...
  var js = ["\u0796\u07ac\u0782\u07aa\u0787\u07a6\u0783\u07a9", "\u078a\u07ac\u0784\u07b0\u0783\u07aa\u0787\u07a6\u0783\u07a9", "\u0789\u07a7\u0783\u07a8\u0797\u07aa", "\u0787\u07ad\u0795\u07b0\u0783\u07a9\u078d\u07aa", "\u0789\u07ad", "\u0796\u07ab\u0782\u07b0", "\u0796\u07aa\u078d\u07a6\u0787\u07a8", "\u0787\u07af\u078e\u07a6\u0790\u07b0\u0793\u07aa", "\u0790\u07ac\u0795\u07b0\u0793\u07ac\u0789\u07b0\u0784\u07a6\u0783\u07aa", "\u0787\u07ae\u0786\u07b0\u0793\u07af\u0784\u07a6\u0783\u07aa", "\u0782\u07ae\u0788\u07ac\u0789\u07b0\u0784\u07a6\u0783\u07aa", "\u0791\u07a8\u0790\u07ac\u0789\u07b0\u0784\u07a6\u0783\u07aa"],
    xs = ["\u0787\u07a7\u078b\u07a8\u0787\u07b0\u078c\u07a6", "\u0780\u07af\u0789\u07a6", "\u0787\u07a6\u0782\u07b0\u078e\u07a7\u0783\u07a6", "\u0784\u07aa\u078b\u07a6", "\u0784\u07aa\u0783\u07a7\u0790\u07b0\u078a\u07a6\u078c\u07a8", "\u0780\u07aa\u0786\u07aa\u0783\u07aa", "\u0780\u07ae\u0782\u07a8\u0780\u07a8\u0783\u07aa"];
  M.defineLocale("dv", {
    months: js,
    monthsShort: js,
    weekdays: xs,
  ...
  var Os = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split("_"),
    Ps = "ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic".split("_"),
  ...
  M.defineLocale("es-do", {
    ...
    monthsShort: function(e, a) {
      return e ? /-MMM-/.test(a) ? Ps[e.month()] : Os[e.month()] : Os
    },
    monthsRegex: Es,
    monthsShortRegex: Es,
  ...
  var As = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split("_"),
    ...
    zs = [/^ene/i, /^feb/i, /^mar/i, /^abr/i, /^may/i, /^jun/i, /^jul/i, /^ago/i, /^sep/i, /^oct/i, /^nov/i, /^dic/i],
    Ns = /^(enero|febrero|marzo|abril|mayo|junio|julio|agosto|septiembre|octubre|noviembre|diciembre|ene\.?|feb\.?|mar\.?|abr\.?|may\.?|jun\.?|jul\.?|ago\.?|sep\.?|oct\.?|nov\.?|dic\.?)/i;
  M.defineLocale("es-us", {
    months: "enero_febrero_marzo_abril_mayo_junio_julio_agosto_septiembre_octubre_noviembre_diciembre".split("_"),
    monthsShort: function(e, a) {
      return e ? /-MMM-/.test(a) ? Fs[e.month()] : As[e.month()] : As
    },
    monthsRegex: Ns,
    monthsShortRegex: Ns,
    monthsStrictRegex: /^(enero|febrero|marzo|abril|mayo|junio|julio|agosto|septiembre|octubre|noviembre|diciembre)/i,
  ...
  var Js = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split("_"),
    ...
    Cs = [/^ene/i, /^feb/i, /^mar/i, /^abr/i, /^may/i, /^jun/i, /^jul/i, /^ago/i, /^sep/i, /^oct/i, /^nov/i, /^dic/i],
    Is = /^(enero|febrero|marzo|abril|mayo|junio|julio|agosto|septiembre|octubre|noviembre|diciembre|ene\.?|feb\.?|mar\.?|abr\.?|may\.?|jun\.?|jul\.?|ago\.?|sep\.?|oct\.?|nov\.?|dic\.?)/i;
  ...
  M.defineLocale("es", {
    months: "enero_febrero_marzo_abril_mayo_junio_julio_agosto_septiembre_octubre_noviembre_diciembre".split("_"),
    monthsShort: function(e, a) {
      return e ? /-MMM-/.test(a) ? Rs[e.month()] : Js[e.month()] : Js
    },
    monthsRegex: Is,
    monthsShortRegex: Is,
    monthsStrictRegex: /^(enero|febrero|marzo|abril|mayo|junio|julio|agosto|septiembre|octubre|noviembre|diciembre)/i,
  ...
  var Bs = "nolla yksi kaksi kolme nelj\xe4 viisi kuusi seitsem\xe4n kahdeksan yhdeks\xe4n".split(" "),
    Ks = ["nolla", "yhden", "kahden", "kolmen", "nelj\xe4n", "viiden", "kuuden", Bs[7], Bs[8], Bs[9]];
  ...
  function qs(e, a, t, s) {
    ...
    return r = s, d = ((n = e) < 10 ? r ? Ks[n] : Bs[n] : n) + " " + d
  }
  M.defineLocale("fi", {
  ...
  var Zs = "jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.".split("_"),
    $s = "jan_feb_mrt_apr_mai_jun_jul_aug_sep_okt_nov_des".split("_");
  M.defineLocale("fy", {
    months: "jannewaris_febrewaris_maart_april_maaie_juny_july_augustus_septimber_oktober_novimber_desimber".split("_"),
    monthsShort: function(e, a) {
      return e ? /-MMM-/.test(a) ? $s[e.month()] : Zs[e.month()] : Zs
    },
    monthsParseExact: !0,
  ...
  var rn = "vas\xe1rnap h\xe9tf\u0151n kedden szerd\xe1n cs\xfct\xf6rt\xf6k\xf6n p\xe9nteken szombaton".split(" ");
  ...
  function _n(e) {
    return (e ? "" : "[m\xfalt] ") + "[" + rn[this.day()] + "] LT[-kor]"
  }
  ...
  function mn(e, a, t, s) {
    ...
    switch (t) {
      ...
      case "ss":
        return on(e) ? n + (a || s ? "sek\xfandur" : "sek\xfandum") : n + "sek\xfanda";
      case "m":
        return a ? "m\xedn\xfata" : "m\xedn\xfatu";
      case "mm":
        return on(e) ? n + (a || s ? "m\xedn\xfatur" : "m\xedn\xfatum") : a ? n + "m\xedn\xfata" : n + "m\xedn\xfatu";
      case "hh":
        return on(e) ? n + (a || s ? "klukkustundir" : "klukkustundum") : n + "klukkustund";
      case "d":
        return a ? "dagur" : s ? "dag" : "degi";
      case "dd":
        return on(e) ? a ? n + "dagar" : n + (s ? "daga" : "d\xf6gum") : a ? n + "dagur" : n + (s ? "dag" : "degi");
      case "M":
        return a ? "m\xe1nu\xf0ur" : s ? "m\xe1nu\xf0" : "m\xe1nu\xf0i";
      case "MM":
        return on(e) ? a ? n + "m\xe1nu\xf0ir" : n + (s ? "m\xe1nu\xf0i" : "m\xe1nu\xf0um") : a ? n + "m\xe1nu\xf0ur" : n + (s ? "m\xe1nu\xf0" : "m\xe1nu\xf0i");
      case "y":
        return a || s ? "\xe1r" : "\xe1ri";
      case "yy":
        return on(e) ? n + (a || s ? "\xe1r" : "\xe1rum") : n + (a || s ? "\xe1r" : "\xe1ri")
    }
  }
  M.defineLocale("hu", {
    ...
    calendar: {
      ...
      nextWeek: function() {
        return _n.call(this, !0)
      },
      lastDay: "[tegnap] LT[-kor]",
      lastWeek: function() {
        return _n.call(this, !1)
      },
      sameElse: "L"
    },
    relativeTime: {
  ...
  var Ln = {
    ...
    yn = ["\u06a9\u0627\u0646\u0648\u0646\u06cc \u062f\u0648\u0648\u06d5\u0645", "\u0634\u0648\u0628\u0627\u062a", "\u0626\u0627\u0632\u0627\u0631", "\u0646\u06cc\u0633\u0627\u0646", "\u0626\u0627\u06cc\u0627\u0631", "\u062d\u0648\u0632\u06d5\u06cc\u0631\u0627\u0646", "\u062a\u06d5\u0645\u0645\u0648\u0632", "\u0626\u0627\u0628", "\u0626\u06d5\u06cc\u0644\u0648\u0648\u0644", "\u062a\u0634\u0631\u06cc\u0646\u06cc \u06cc\u06d5\u0643\u06d5\u0645", "\u062a\u0634\u0631\u06cc\u0646\u06cc \u062f\u0648\u0648\u06d5\u0645", "\u0643\u0627\u0646\u0648\u0646\u06cc \u06cc\u06d5\u06a9\u06d5\u0645"];
  M.defineLocale("ku", {
    months: yn,
    monthsShort: yn,
  ...
  M.defineLocale("ky", {
    ...
    ordinal: function(e) {
      return e + (fn[e] || fn[e % 10] || fn[100 <= e ? 100 : null])
    },
    week: {
      dow: 1,
      doy: 7
    ...
    relativeTime: {
      future: function(e) {
        return kn(e.substr(0, e.indexOf(" "))) ? "a " + e : "an " + e
      },
      past: function(e) {
        return kn(e.substr(0, e.indexOf(" "))) ? "viru " + e : "virun " + e
      },
      s: "e puer Sekonnen",
      ss: "%d Sekonnen",
      m: pn,
  ...
  function vn(e, a, t, s) {
    var n = e + " ";
    return 1 === e ? n + Tn(0, a, t[0], s) : a ? n + (gn(e) ? wn(t)[1] : wn(t)[0]) : s ? n + wn(t)[1] : n + (gn(e) ? wn(t)[1] : wn(t)[2])
  }
  M.defineLocale("lt", {
    months: {
  ...
  var Jn = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split("_"),
    Rn = "jan_feb_mrt_apr_mei_jun_jul_aug_sep_okt_nov_dec".split("_"),
    Cn = [/^jan/i, /^feb/i, /^maart|mrt.?$/i, /^apr/i, /^mei$/i, /^jun[i.]?$/i, /^jul[i.]?$/i, /^aug/i, /^sep/i, /^okt/i, /^nov/i, /^dec/i],
    In = /^(januari|februari|maart|april|mei|ju[nl]i|augustus|september|oktober|november|december|jan\.?|feb\.?|mrt\.?|apr\.?|ju[nl]\.?|aug\.?|sep\.?|okt\.?|nov\.?|dec\.?)/i;
  M.defineLocale("nl-be", {
    months: "januari_februari_maart_april_mei_juni_juli_augustus_september_oktober_november_december".split("_"),
    monthsShort: function(e, a) {
      return e ? /-MMM-/.test(a) ? Rn[e.month()] : Jn[e.month()] : Jn
    },
    monthsRegex: In,
    monthsShortRegex: In,
  ...
  var Un = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split("_"),
  ...
  M.defineLocale("nl", {
    months: "januari_februari_maart_april_mei_juni_juli_augustus_september_oktober_november_december".split("_"),
    monthsShort: function(e, a) {
      return e ? /-MMM-/.test(a) ? Gn[e.month()] : Un[e.month()] : Un
    },
    monthsRegex: Bn,
    monthsShortRegex: Bn,
    monthsStrictRegex: /^(januari|februari|maart|april|mei|ju[nl]i|augustus|september|oktober|november|december)/i,
  ...
  var Zn = "stycze\u0144_luty_marzec_kwiecie\u0144_maj_czerwiec_lipiec_sierpie\u0144_wrzesie\u0144_pa\u017adziernik_listopad_grudzie\u0144".split("_"),
  ...
  function Xn(e, a, t) {
    ...
    switch (t) {
      case "ss":
        return s + (Qn(e) ? "sekundy" : "sekund");
      case "m":
        return a ? "minuta" : "minut\u0119";
      case "mm":
        return s + (Qn(e) ? "minuty" : "minut");
      case "h":
        return a ? "godzina" : "godzin\u0119";
      case "hh":
        return s + (Qn(e) ? "godziny" : "godzin");
      case "MM":
        return s + (Qn(e) ? "miesi\u0105ce" : "miesi\u0119cy");
      case "yy":
        return s + (Qn(e) ? "lata" : "lat")
    }
  }
  ...
  M.defineLocale("pl", {
    months: function(e, a) {
      return e ? "" === a ? "(" + $n[e.month()] + "|" + Zn[e.month()] + ")" : /D MMMM/.test(a) ? $n[e.month()] : Zn[e.month()] : Zn
    },
  ...
  var tr = [/^\u044f\u043d\u0432/i, /^\u0444\u0435\u0432/i, /^\u043c\u0430\u0440/i, /^\u0430\u043f\u0440/i, /^\u043c\u0430[\u0439\u044f]/i, /^\u0438\u044e\u043d/i, /^\u0438\u044e\u043b/i, /^\u0430\u0432\u0433/i, /^\u0441\u0435\u043d/i, /^\u043e\u043a\u0442/i, /^\u043d\u043e\u044f/i, /^\u0434\u0435\u043a/i];
  M.defineLocale("ru", {
    months: {
  ...
  var sr = ["\u062c\u0646\u0648\u0631\u064a", "\u0641\u064a\u0628\u0631\u0648\u0631\u064a", "\u0645\u0627\u0631\u0686", "\u0627\u067e\u0631\u064a\u0644", "\u0645\u0626\u064a", "\u062c\u0648\u0646", "\u062c\u0648\u0644\u0627\u0621\u0650", "\u0622\u06af\u0633\u067d", "\u0633\u064a\u067e\u067d\u0645\u0628\u0631", "\u0622\u06aa\u067d\u0648\u0628\u0631", "\u0646\u0648\u0645\u0628\u0631", "\u068a\u0633\u0645\u0628\u0631"],
    nr = ["\u0622\u0686\u0631", "\u0633\u0648\u0645\u0631", "\u0627\u06b1\u0627\u0631\u0648", "\u0627\u0631\u0628\u0639", "\u062e\u0645\u064a\u0633", "\u062c\u0645\u0639", "\u0687\u0646\u0687\u0631"];
  M.defineLocale("sd", {
    months: sr,
    monthsShort: sr,
    weekdays: nr,
  ...
  var rr = "janu\xe1r_febru\xe1r_marec_apr\xedl_m\xe1j_j\xfan_j\xfal_august_september_okt\xf3ber_november_december".split("_"),
  ...
  function ir(e, a, t, s) {
    ...
    switch (t) {
      ...
      case "ss":
        return a || s ? n + (_r(e) ? "sekundy" : "sek\xfand") : n + "sekundami";
      case "m":
        return a ? "min\xfata" : s ? "min\xfatu" : "min\xfatou";
      case "mm":
        return a || s ? n + (_r(e) ? "min\xfaty" : "min\xfat") : n + "min\xfatami";
      case "h":
        return a ? "hodina" : s ? "hodinu" : "hodinou";
      case "hh":
        return a || s ? n + (_r(e) ? "hodiny" : "hod\xedn") : n + "hodinami";
      case "d":
        return a || s ? "de\u0148" : "d\u0148om";
      case "dd":
        return a || s ? n + (_r(e) ? "dni" : "dn\xed") : n + "d\u0148ami";
      case "M":
        return a || s ? "mesiac" : "mesiacom";
      case "MM":
        return a || s ? n + (_r(e) ? "mesiace" : "mesiacov") : n + "mesiacmi";
      case "y":
        return a || s ? "rok" : "rokom";
      case "yy":
        return a || s ? n + (_r(e) ? "roky" : "rokov") : n + "rokmi"
    }
  }
  ...
  var mr = {
    ...
    translate: function(e, a, t) {
      var s = mr.words[t];
      return 1 === t.length ? a ? s[0] : s[1] : e + " " + mr.correctGrammaticalCase(e, s)
    }
  };
  ...
  M.defineLocale("tg", {
    ...
    ordinal: function(e) {
      return e + (hr[e] || hr[e % 10] || hr[100 <= e ? 100 : null])
    },
    week: {
      dow: 1,
      doy: 7
  ...
  var cr = "pagh_wa\u2019_cha\u2019_wej_loS_vagh_jav_Soch_chorgh_Hut".split("_");
    ...
    ordinal: function(e, a) {
      switch (a) {
        ...
        default:
          if (0 === e) return e + "'\u0131nc\u0131";
          var t = e % 10;
          return e + (Yr[t] || Yr[e % 100 - t] || Yr[100 <= e ? 100 : null])
      }
    },
    week: {
      dow: 1,
  ...
  var kr = ["\u062c\u0646\u0648\u0631\u06cc", "\u0641\u0631\u0648\u0631\u06cc", "\u0645\u0627\u0631\u0686", "\u0627\u067e\u0631\u06cc\u0644", "\u0645\u0626\u06cc", "\u062c\u0648\u0646", "\u062c\u0648\u0644\u0627\u0626\u06cc", "\u0627\u06af\u0633\u062a", "\u0633\u062a\u0645\u0628\u0631", "\u0627\u06a9\u062a\u0648\u0628\u0631", "\u0646\u0648\u0645\u0628\u0631", "\u062f\u0633\u0645\u0628\u0631"],
    Dr = ["\u0627\u062a\u0648\u0627\u0631", "\u067e\u06cc\u0631", "\u0645\u0646\u06af\u0644", "\u0628\u062f\u06be", "\u062c\u0645\u0639\u0631\u0627\u062a", "\u062c\u0645\u0639\u06c1", "\u06c1\u0641\u062a\u06c1"];
